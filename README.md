...
> **Personal note:** I forked this primarily to study how multi-agent LLM systems are structured and to experiment with adding new analyst agents. The Warren Buffett and Charlie Munger agents are particularly interesting to compare side-by-side.
