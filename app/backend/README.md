...
> **Personal note:** I also run the server on port 8080 sometimes to avoid conflicts with other local services. Use `--port 8080` to override, e.g. `poetry run uvicorn main:app --reload --port 8080`.
